...
<div id="container">
  <h1 id="title">URL SHAPESHIFTER</h1>
  <!--<ul id="navigation">
...
?>
  ...
  <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    <ul id="form">
      <li id="address_bar"><label> <input id="address_box" type="text" name="<?php echo $GLOBALS['_config']['url_var_name'] ?>" value="<?php echo isset($GLOBALS['_url']) ? htmlspecialchars($GLOBALS['_url']) : '' ?>" onfocus="this.select()" /></label> <input id="go" type="submit" value="Go" /></li>
      <?php
  ...
  <div id="footer"><a href="http://whitefyre.com/poxy/">PHProxy</a> 
<?php echo $GLOBALS['_version'] ?> | Hosted by Sleuthboy
<br><br>
Alternatives: <a href="../mp">mp</a> <a href="../a2">a2</a> <a href="http://nashma4.appspot.com">appspot</a> <a href="http://p0lym47h.herokuapp.com">heroku</a>
</div>
</body>
</html>
