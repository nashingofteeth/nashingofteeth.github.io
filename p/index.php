...
$_labels            = array
                    (
                        ...
                        'remove_scripts'  => array('Remove Scripts', 'Remove client-side scripting'), 
...
else
{
    ...
    {
        $_url_form      = '<span style="width:100%;position:absolute;top:0px;left:0px;text-align:center;border-bottom:1px solid #725554;color:#000000;background-color:#F2FDF3;font-size:12px;font-weight:bold;font-family:Bitstream Vera Sans,arial,sans-serif;padding:4px;">'
