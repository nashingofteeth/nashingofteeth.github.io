...
(function () {
  ...
  // Enter applies the filter, then drops focus so "1"–"9" opens the nth
  // visible photo (digits type into a focused input instead of navigating).
  // Empty search has nothing to apply but still blurs. allowInEditable
  // because the handler explicitly manages the focused-input case below
  // (other text-editing fields are still ignored).
  onKey(
    "enter",
    (e) => {
